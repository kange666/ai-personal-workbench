...
describe("workbench store", () => {
  ...
  it("creates a daily task with a concrete date", () => {
    ...
    store.addTask({ title: "新增每日任务", project: "AI 个人工作台", scope: "day", priority: "P1", plannedDate: "2026-08-04", weekStart: "2026-08-03", startDate: "2026-08-03", endDate: "2026-08-07", progress: 0, note: "测试" });
  ...
  it("creates a weekly task without forcing a day", () => {
    const store = useWorkbenchStore();
    store.addTask({ title: "新增每周任务", project: "AI 个人工作台", scope: "week", priority: "P1", plannedDate: "2026-08-04", weekStart: "2026-08-03", startDate: "2026-08-03", endDate: "2026-08-07", progress: 0, note: "整周管理" });
  ...
  it("keeps project start, end and progress for the gantt view", () => {
    const store = useWorkbenchStore();
    store.addTask({ title: "甘特项目任务", project: "AI 个人工作台", scope: "project", priority: "P0", plannedDate: "2026-08-04", weekStart: "2026-08-03", startDate: "2026-08-05", endDate: "2026-08-12", progress: 35, note: "用于甘特联动" });
