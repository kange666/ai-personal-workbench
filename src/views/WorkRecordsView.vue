...
<template><div class="view work-records-view"><header class="page-header"><div><h1>工作记录</h1><p>按天、周查看工作成果与工时</p></div><div><button class="button secondary" :disabled="loading" @click="load">↻ 重新整理</button></div></header>
