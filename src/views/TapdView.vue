      ...
      <aside class="activity-drawer panel tapd-drawer">
        ...
        <section v-if="selectedJob" class="tapd-job-result">
          ...
          <div v-if="selectedJob.status === 'completed'" class="tapd-closure">
            ...
            <div>
              <b>人工确认</b>
              <small>继续修改会返回原任务；确认完成后回写 TAPD</small>
